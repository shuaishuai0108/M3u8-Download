...
class M3u8(object):
    ...
    def download_process(self, urls):
        ...
        po = Pool(self.cpu_count)  # 定义一个进程池，最大进程数3

        for num, url in enumerate(urls, 1):
            ts_flie_name = self.path_ts + "\\" + str(num) + '.ts'
            jindu = [num, len(urls)]
            po.apply_async(self.download, args=(url, ts_flie_name, jindu))
...
if __name__ == '__main__':
    ...
    url = 'http://guihua.feifei-kuyun.com/20200128/29953_31d33d8b/index.m3u8'
    name = '26'
    path = 'D:\爱情公寓5'
